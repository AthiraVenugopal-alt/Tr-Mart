...
public class ManageNewsPage 
{
	...
	@FindBy(xpath = "//button[@name='Search']")private WebElement searchButtonOnSearchPage;
	@FindBy (xpath = "//h5[text()=' Alert!']")private WebElement newNewsAlert;
	@FindBy(xpath = "//td[text()='20% Discount on all garments']")private WebElement searchNewsIsDisplayed;
	@FindBy(xpath = "//h4[text()='Manage News']")private WebElement refreshNewsDisplayed;
